...
(function () {
  ...
  const data = {
    ...
    rules: [
      { k: 'Reward : Risk ≥ 1.8', v: '1 : 2.1', ok: true },
      { k: 'Spread ≤ 25 จุด', v: '18 จุด', ok: true },
      { k: 'ขนาดไม้ ≤ 0.20 lot', v: '0.10 lot', ok: true },
      { k: 'ขาดทุนสะสมวันนี้ ≤ 3%', v: '‑0.6%', ok: true }
    ],
  ...
  window.Sim = {
    data, init, update, toggle, enterIdle, enterSignal,
