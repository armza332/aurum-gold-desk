...
- EA (ชั้น 3): `mt5/Aurum_EA.mq5` **v1.2.0** — โชว์เวอร์ชันบนกราฟ + ส่งขึ้นเว็บให้ตรวจสอบ
...
5. มุมกราฟต้องขึ้น `🥇 AURUM — XAU AI Desk v1.2.0 …`
...
3. ปุ่มควรเปลี่ยนเป็น 🟢 **"สด · EA v1.2.0"**

## 4) ตรวจสอบเวอร์ชัน (สำคัญ)
- ปุ่มมุมขวาบน / แถบล่างของเว็บ ต้องโชว์ **EA v1.2.0**
...
- **การตัดสินใจ**: โหวต HAWK ×5 (Trend/Structure/Fade/Bollinger/Fib) + ผล n/5 + SAGE (ผ่าน/VETO) + กฎเหล็ก · น้ำหนัก (w) แต่ละตัวปรับเองตามผลงาน
- **สรุปผล**: ไม้/ชนะ/แพ้/กำไร วันนี้+สัปดาห์ (จากประวัติจริง) + พอร์ต = equity จริง
- **บทเรียน**: ไม้ที่แพ้จริง (เตือนตัวเอง)
- **ข่าว & อารมณ์ตลาด**: Fear&Greed จริง (alternative.me) · DXY/Funding ยัง "—" (เฟสถัดไป)
