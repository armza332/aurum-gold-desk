...
- EA (ชั้น 3): `mt5/Aurum_EA.mq5` **v1.1.0** — โชว์เวอร์ชันบนกราฟ + ส่งขึ้นเว็บให้ตรวจสอบ
...
5. มุมกราฟต้องขึ้น `🥇 AURUM — XAU AI Desk v1.1.0 …`
...
3. ปุ่มควรเปลี่ยนเป็น 🟢 **"สด · EA v1.1.0"**

## 4) ตรวจสอบเวอร์ชัน (สำคัญ)
- ปุ่มมุมขวาบน / แถบล่างของเว็บ ต้องโชว์ **EA v1.1.0**
